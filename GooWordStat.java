...
public final class GooWordStat {
    ...
    public String toString() {
        String freqType = "";
        if (freq < 1000) freqType = "LOW";
        if (freq >= 1000 && freq < 100000 ) freqType = "MEDIUM";
        if (freq >= 100000 && freq < 10000000 ) freqType = "HIGH";
        if (freq >= 10000000 ) freqType = "EXTRA HIGH";

        return "Word is [" + getWord() + "], search freq is " + freqType;
    }
}
